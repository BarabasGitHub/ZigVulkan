...
pub const struct_VkInstance_T = @Type(.Opaque);
pub const VkInstance = ?*struct_VkInstance_T;
pub const struct_VkPhysicalDevice_T = @Type(.Opaque);
pub const VkPhysicalDevice = ?*struct_VkPhysicalDevice_T;
pub const struct_VkDevice_T = @Type(.Opaque);
pub const VkDevice = ?*struct_VkDevice_T;
pub const struct_VkQueue_T = @Type(.Opaque);
pub const VkQueue = ?*struct_VkQueue_T;
pub const struct_VkSemaphore_T = @Type(.Opaque);
pub const VkSemaphore = ?*struct_VkSemaphore_T;
pub const struct_VkCommandBuffer_T = @Type(.Opaque);
pub const VkCommandBuffer = ?*struct_VkCommandBuffer_T;
pub const struct_VkFence_T = @Type(.Opaque);
pub const VkFence = ?*struct_VkFence_T;
pub const struct_VkDeviceMemory_T = @Type(.Opaque);
pub const VkDeviceMemory = ?*struct_VkDeviceMemory_T;
pub const struct_VkBuffer_T = @Type(.Opaque);
pub const VkBuffer = ?*struct_VkBuffer_T;
pub const struct_VkImage_T = @Type(.Opaque);
pub const VkImage = ?*struct_VkImage_T;
pub const struct_VkEvent_T = @Type(.Opaque);
pub const VkEvent = ?*struct_VkEvent_T;
pub const struct_VkQueryPool_T = @Type(.Opaque);
pub const VkQueryPool = ?*struct_VkQueryPool_T;
pub const struct_VkBufferView_T = @Type(.Opaque);
pub const VkBufferView = ?*struct_VkBufferView_T;
pub const struct_VkImageView_T = @Type(.Opaque);
pub const VkImageView = ?*struct_VkImageView_T;
pub const struct_VkShaderModule_T = @Type(.Opaque);
pub const VkShaderModule = ?*struct_VkShaderModule_T;
pub const struct_VkPipelineCache_T = @Type(.Opaque);
pub const VkPipelineCache = ?*struct_VkPipelineCache_T;
pub const struct_VkPipelineLayout_T = @Type(.Opaque);
pub const VkPipelineLayout = ?*struct_VkPipelineLayout_T;
pub const struct_VkRenderPass_T = @Type(.Opaque);
pub const VkRenderPass = ?*struct_VkRenderPass_T;
pub const struct_VkPipeline_T = @Type(.Opaque);
pub const VkPipeline = ?*struct_VkPipeline_T;
pub const struct_VkDescriptorSetLayout_T = @Type(.Opaque);
pub const VkDescriptorSetLayout = ?*struct_VkDescriptorSetLayout_T;
pub const struct_VkSampler_T = @Type(.Opaque);
pub const VkSampler = ?*struct_VkSampler_T;
pub const struct_VkDescriptorPool_T = @Type(.Opaque);
pub const VkDescriptorPool = ?*struct_VkDescriptorPool_T;
pub const struct_VkDescriptorSet_T = @Type(.Opaque);
pub const VkDescriptorSet = ?*struct_VkDescriptorSet_T;
pub const struct_VkFramebuffer_T = @Type(.Opaque);
pub const VkFramebuffer = ?*struct_VkFramebuffer_T;
pub const struct_VkCommandPool_T = @Type(.Opaque);
...
pub const struct_VkSamplerYcbcrConversion_T = @Type(.Opaque);
pub const VkSamplerYcbcrConversion = ?*struct_VkSamplerYcbcrConversion_T;
pub const struct_VkDescriptorUpdateTemplate_T = @Type(.Opaque);
...
pub const struct_VkSurfaceKHR_T = @Type(.Opaque);
...
pub const struct_VkSwapchainKHR_T = @Type(.Opaque);
...
pub const struct_VkDisplayKHR_T = @Type(.Opaque);
pub const VkDisplayKHR = ?*struct_VkDisplayKHR_T;
pub const struct_VkDisplayModeKHR_T = @Type(.Opaque);
...
pub const struct_VkDebugReportCallbackEXT_T = @Type(.Opaque);
...
pub const struct_VkObjectTableNVX_T = @Type(.Opaque);
pub const VkObjectTableNVX = ?*struct_VkObjectTableNVX_T;
pub const struct_VkIndirectCommandsLayoutNVX_T = @Type(.Opaque);
...
pub const struct_VkDebugUtilsMessengerEXT_T = @Type(.Opaque);
...
pub const struct_VkValidationCacheEXT_T = @Type(.Opaque);
...
pub const struct_VkAccelerationStructureNV_T = @Type(.Opaque);
...
pub const struct_VkPerformanceConfigurationINTEL_T = @Type(.Opaque);
...
pub const struct_GLFWmonitor = @Type(.Opaque);
pub const GLFWmonitor = struct_GLFWmonitor;
pub const struct_GLFWwindow = @Type(.Opaque);
pub const GLFWwindow = struct_GLFWwindow;
pub const struct_GLFWcursor = @Type(.Opaque);
...
pub const VK_DEFINE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // E:/Libraries/VulkanSDK/1.1.121.2/Include\vulkan/vulkan_core.h:53:9
pub const VK_DEFINE_NON_DISPATCHABLE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // E:/Libraries/VulkanSDK/1.1.121.2/Include\vulkan/vulkan_core.h:58:17
...
pub const _MSC_FULL_VER = 192729110;
...
pub inline fn VK_VERSION_MAJOR(version: anytype) @TypeOf((@import("std").meta.cast(uint32_t, version)) >> 22) {
    return (@import("std").meta.cast(uint32_t, version)) >> 22;
}
pub inline fn VK_VERSION_MINOR(version: anytype) @TypeOf(((@import("std").meta.cast(uint32_t, version)) >> 12) & 0x3ff) {
    return ((@import("std").meta.cast(uint32_t, version)) >> 12) & 0x3ff;
}
pub inline fn VK_VERSION_PATCH(version: anytype) @TypeOf((@import("std").meta.cast(uint32_t, version)) & 0xfff) {
    return (@import("std").meta.cast(uint32_t, version)) & 0xfff;
}
