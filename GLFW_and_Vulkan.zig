...
pub const VK_ERROR_UNKNOWN = @enumToInt(enum_VkResult.VK_ERROR_UNKNOWN);
...
pub const VK_ERROR_FRAGMENTATION = @enumToInt(enum_VkResult.VK_ERROR_FRAGMENTATION);
pub const VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS = @enumToInt(enum_VkResult.VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS);
...
pub const VK_ERROR_INCOMPATIBLE_VERSION_KHR = @enumToInt(enum_VkResult.VK_ERROR_INCOMPATIBLE_VERSION_KHR);
...
pub const VK_THREAD_IDLE_KHR = @enumToInt(enum_VkResult.VK_THREAD_IDLE_KHR);
pub const VK_THREAD_DONE_KHR = @enumToInt(enum_VkResult.VK_THREAD_DONE_KHR);
pub const VK_OPERATION_DEFERRED_KHR = @enumToInt(enum_VkResult.VK_OPERATION_DEFERRED_KHR);
pub const VK_OPERATION_NOT_DEFERRED_KHR = @enumToInt(enum_VkResult.VK_OPERATION_NOT_DEFERRED_KHR);
pub const VK_PIPELINE_COMPILE_REQUIRED_EXT = @enumToInt(enum_VkResult.VK_PIPELINE_COMPILE_REQUIRED_EXT);
...
pub const VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS_KHR = @enumToInt(enum_VkResult.VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS_KHR);
pub const VK_ERROR_PIPELINE_COMPILE_REQUIRED_EXT = @enumToInt(enum_VkResult.VK_ERROR_PIPELINE_COMPILE_REQUIRED_EXT);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_PROPERTIES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_PROPERTIES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES);
pub const VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO);
pub const VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2 = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2);
pub const VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2 = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2);
pub const VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2 = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2);
pub const VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2 = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2);
pub const VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2 = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2);
pub const VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO);
pub const VK_STRUCTURE_TYPE_SUBPASS_END_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SUBPASS_END_INFO);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES);
pub const VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES);
pub const VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO);
pub const VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES);
pub const VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES);
pub const VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES);
pub const VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES);
pub const VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO);
pub const VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO);
pub const VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES);
pub const VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT);
pub const VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES);
pub const VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO);
pub const VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO);
pub const VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO);
pub const VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES);
pub const VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO);
pub const VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO);
pub const VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO);
pub const VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO);
...
pub const VK_STRUCTURE_TYPE_IMAGE_VIEW_ADDRESS_PROPERTIES_NVX = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMAGE_VIEW_ADDRESS_PROPERTIES_NVX);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_PROPERTIES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_PROPERTIES_KHR);
pub const VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_CREATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR);
pub const VK_STRUCTURE_TYPE_ACQUIRE_PROFILING_LOCK_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACQUIRE_PROFILING_LOCK_INFO_KHR);
pub const VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_KHR);
pub const VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_DESCRIPTION_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_DESCRIPTION_KHR);
...
pub const VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_KHR);
pub const VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_GEOMETRY_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_GEOMETRY_INFO_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_GEOMETRY_TYPE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_GEOMETRY_TYPE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_AABBS_DATA_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_AABBS_DATA_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_INSTANCES_DATA_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_INSTANCES_DATA_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_TRIANGLES_DATA_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_TRIANGLES_DATA_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_KHR);
pub const VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_TO_MEMORY_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_TO_MEMORY_INFO_KHR);
pub const VK_STRUCTURE_TYPE_COPY_MEMORY_TO_ACCELERATION_STRUCTURE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COPY_MEMORY_TO_ACCELERATION_STRUCTURE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_KHR);
pub const VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_INTERFACE_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_INTERFACE_CREATE_INFO_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR);
...
pub const VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_QUERY_CREATE_INFO_INTEL = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_QUERY_CREATE_INFO_INTEL);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES_EXT);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_FEATURES_EXT);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_DEFERRED_OPERATION_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DEFERRED_OPERATION_INFO_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_NV);
pub const VK_STRUCTURE_TYPE_GRAPHICS_SHADER_GROUP_CREATE_INFO_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_GRAPHICS_SHADER_GROUP_CREATE_INFO_NV);
pub const VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_SHADER_GROUPS_CREATE_INFO_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_SHADER_GROUPS_CREATE_INFO_NV);
pub const VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_NV);
pub const VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NV);
pub const VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_NV);
pub const VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_NV);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_NV);
...
pub const VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDER_PASS_TRANSFORM_INFO_QCOM = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDER_PASS_TRANSFORM_INFO_QCOM);
pub const VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_EXT);
pub const VK_STRUCTURE_TYPE_SAMPLER_CUSTOM_BORDER_COLOR_CREATE_INFO_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SAMPLER_CUSTOM_BORDER_COLOR_CREATE_INFO_EXT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_PROPERTIES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_PROPERTIES_EXT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_PIPELINE_LIBRARY_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PIPELINE_LIBRARY_CREATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_DEVICE_PRIVATE_DATA_CREATE_INFO_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DEVICE_PRIVATE_DATA_CREATE_INFO_EXT);
pub const VK_STRUCTURE_TYPE_PRIVATE_DATA_SLOT_CREATE_INFO_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PRIVATE_DATA_SLOT_CREATE_INFO_EXT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV);
pub const VK_STRUCTURE_TYPE_DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_PROPERTIES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_PROPERTIES_EXT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_DIRECTFB_SURFACE_CREATE_INFO_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DIRECTFB_SURFACE_CREATE_INFO_EXT);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES_KHR);
pub const VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR);
pub const VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO_KHR);
pub const VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT_KHR);
pub const VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_KHR);
pub const VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO_KHR);
pub const VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO_KHR);
...
pub const VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL);
pub const VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL);
pub const VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL);
pub const VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL);
...
pub const VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL_KHR = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL_KHR);
pub const VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL_KHR = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL_KHR);
pub const VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL_KHR = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_STENCIL_ATTACHMENT_OPTIMAL_KHR);
pub const VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL_KHR = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_STENCIL_READ_ONLY_OPTIMAL_KHR);
...
pub const VK_OBJECT_TYPE_ACCELERATION_STRUCTURE_KHR = @enumToInt(enum_VkObjectType.VK_OBJECT_TYPE_ACCELERATION_STRUCTURE_KHR);
...
pub const VK_OBJECT_TYPE_DEFERRED_OPERATION_KHR = @enumToInt(enum_VkObjectType.VK_OBJECT_TYPE_DEFERRED_OPERATION_KHR);
pub const VK_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_NV = @enumToInt(enum_VkObjectType.VK_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_NV);
pub const VK_OBJECT_TYPE_PRIVATE_DATA_SLOT_EXT = @enumToInt(enum_VkObjectType.VK_OBJECT_TYPE_PRIVATE_DATA_SLOT_EXT);
...
pub const VK_VENDOR_ID_CODEPLAY = @enumToInt(enum_VkVendorId.VK_VENDOR_ID_CODEPLAY);
pub const VK_VENDOR_ID_MESA = @enumToInt(enum_VkVendorId.VK_VENDOR_ID_MESA);
...
pub const VK_QUERY_TYPE_PERFORMANCE_QUERY_KHR = @enumToInt(enum_VkQueryType.VK_QUERY_TYPE_PERFORMANCE_QUERY_KHR);
pub const VK_QUERY_TYPE_ACCELERATION_STRUCTURE_COMPACTED_SIZE_KHR = @enumToInt(enum_VkQueryType.VK_QUERY_TYPE_ACCELERATION_STRUCTURE_COMPACTED_SIZE_KHR);
pub const VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SERIALIZATION_SIZE_KHR = @enumToInt(enum_VkQueryType.VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SERIALIZATION_SIZE_KHR);
...
pub const VK_DYNAMIC_STATE_CULL_MODE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_CULL_MODE_EXT);
pub const VK_DYNAMIC_STATE_FRONT_FACE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_FRONT_FACE_EXT);
pub const VK_DYNAMIC_STATE_PRIMITIVE_TOPOLOGY_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_PRIMITIVE_TOPOLOGY_EXT);
pub const VK_DYNAMIC_STATE_VIEWPORT_WITH_COUNT_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_VIEWPORT_WITH_COUNT_EXT);
pub const VK_DYNAMIC_STATE_SCISSOR_WITH_COUNT_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_SCISSOR_WITH_COUNT_EXT);
pub const VK_DYNAMIC_STATE_VERTEX_INPUT_BINDING_STRIDE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_VERTEX_INPUT_BINDING_STRIDE_EXT);
pub const VK_DYNAMIC_STATE_DEPTH_TEST_ENABLE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_DEPTH_TEST_ENABLE_EXT);
pub const VK_DYNAMIC_STATE_DEPTH_WRITE_ENABLE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_DEPTH_WRITE_ENABLE_EXT);
pub const VK_DYNAMIC_STATE_DEPTH_COMPARE_OP_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_DEPTH_COMPARE_OP_EXT);
pub const VK_DYNAMIC_STATE_DEPTH_BOUNDS_TEST_ENABLE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_DEPTH_BOUNDS_TEST_ENABLE_EXT);
pub const VK_DYNAMIC_STATE_STENCIL_TEST_ENABLE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_STENCIL_TEST_ENABLE_EXT);
pub const VK_DYNAMIC_STATE_STENCIL_OP_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_STENCIL_OP_EXT);
...
pub const VK_BORDER_COLOR_FLOAT_CUSTOM_EXT = @enumToInt(enum_VkBorderColor.VK_BORDER_COLOR_FLOAT_CUSTOM_EXT);
pub const VK_BORDER_COLOR_INT_CUSTOM_EXT = @enumToInt(enum_VkBorderColor.VK_BORDER_COLOR_INT_CUSTOM_EXT);
...
pub const VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR = @enumToInt(enum_VkDescriptorType.VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR);
...
pub const VK_ATTACHMENT_STORE_OP_NONE_QCOM = @enumToInt(enum_VkAttachmentStoreOp.VK_ATTACHMENT_STORE_OP_NONE_QCOM);
...
pub const VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR = @enumToInt(enum_VkPipelineBindPoint.VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR);
...
pub const VK_INDEX_TYPE_NONE_KHR = @enumToInt(enum_VkIndexType.VK_INDEX_TYPE_NONE_KHR);
...
pub const VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_KHR = @enumToInt(enum_VkAccessFlagBits.VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_KHR);
pub const VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_KHR = @enumToInt(enum_VkAccessFlagBits.VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_KHR);
...
pub const VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_NV = @enumToInt(enum_VkAccessFlagBits.VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_NV);
pub const VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_NV = @enumToInt(enum_VkAccessFlagBits.VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_NV);
...
pub const VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT = @enumToInt(enum_VkFormatFeatureFlagBits.VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT);
...
pub const VK_FORMAT_FEATURE_ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR = @enumToInt(enum_VkFormatFeatureFlagBits.VK_FORMAT_FEATURE_ACCELERATION_STRUCTURE_VERTEX_BUFFER_BIT_KHR);
...
pub const VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR = @enumToInt(enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR);
pub const VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR = @enumToInt(enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR);
...
pub const VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV = @enumToInt(enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV);
...
pub const VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT = @enumToInt(enum_VkBufferCreateFlagBits.VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT);
...
pub const VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = @enumToInt(enum_VkBufferCreateFlagBits.VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR);
...
pub const VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT = @enumToInt(enum_VkBufferUsageFlagBits.VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT);
...
pub const VK_BUFFER_USAGE_RAY_TRACING_BIT_KHR = @enumToInt(enum_VkBufferUsageFlagBits.VK_BUFFER_USAGE_RAY_TRACING_BIT_KHR);
...
pub const VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_KHR = @enumToInt(enum_VkBufferUsageFlagBits.VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_KHR);
...
pub const VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT = @enumToInt(enum_VkImageViewCreateFlagBits.VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT);
...
pub const VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT_EXT = @enumToInt(enum_VkPipelineCacheCreateFlagBits.VK_PIPELINE_CACHE_CREATE_EXTERNALLY_SYNCHRONIZED_BIT_EXT);
pub const VK_PIPELINE_CACHE_CREATE_FLAG_BITS_MAX_ENUM = @enumToInt(enum_VkPipelineCacheCreateFlagBits.VK_PIPELINE_CACHE_CREATE_FLAG_BITS_MAX_ENUM);
pub const enum_VkPipelineCacheCreateFlagBits = extern enum(c_int) {
...
pub const VK_PIPELINE_CREATE_DISPATCH_BASE_BIT = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_DISPATCH_BASE_BIT);
pub const VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR);
pub const VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_CLOSEST_HIT_SHADERS_BIT_KHR);
pub const VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_MISS_SHADERS_BIT_KHR);
pub const VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_INTERSECTION_SHADERS_BIT_KHR);
pub const VK_PIPELINE_CREATE_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR);
pub const VK_PIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHR = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHR);
...
pub const VK_PIPELINE_CREATE_INDIRECT_BINDABLE_BIT_NV = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_INDIRECT_BINDABLE_BIT_NV);
pub const VK_PIPELINE_CREATE_LIBRARY_BIT_KHR = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_LIBRARY_BIT_KHR);
pub const VK_PIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_EXT = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_FAIL_ON_PIPELINE_COMPILE_REQUIRED_BIT_EXT);
pub const VK_PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BIT_EXT = @enumToInt(enum_VkPipelineCreateFlagBits.VK_PIPELINE_CREATE_EARLY_RETURN_ON_FAILURE_BIT_EXT);
...
pub const VK_SHADER_STAGE_RAYGEN_BIT_KHR = @enumToInt(enum_VkShaderStageFlagBits.VK_SHADER_STAGE_RAYGEN_BIT_KHR);
pub const VK_SHADER_STAGE_ANY_HIT_BIT_KHR = @enumToInt(enum_VkShaderStageFlagBits.VK_SHADER_STAGE_ANY_HIT_BIT_KHR);
pub const VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR = @enumToInt(enum_VkShaderStageFlagBits.VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR);
pub const VK_SHADER_STAGE_MISS_BIT_KHR = @enumToInt(enum_VkShaderStageFlagBits.VK_SHADER_STAGE_MISS_BIT_KHR);
pub const VK_SHADER_STAGE_INTERSECTION_BIT_KHR = @enumToInt(enum_VkShaderStageFlagBits.VK_SHADER_STAGE_INTERSECTION_BIT_KHR);
pub const VK_SHADER_STAGE_CALLABLE_BIT_KHR = @enumToInt(enum_VkShaderStageFlagBits.VK_SHADER_STAGE_CALLABLE_BIT_KHR);
...
pub const VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT = @enumToInt(enum_VkDescriptorPoolCreateFlagBits.VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT);
...
pub const VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT = @enumToInt(enum_VkDescriptorSetLayoutCreateFlagBits.VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT);
...
pub const VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT = @enumToInt(enum_VkFramebufferCreateFlagBits.VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT);
...
pub const VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM = @enumToInt(enum_VkRenderPassCreateFlagBits.VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM);
...
pub const VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_QCOM = @enumToInt(enum_VkSubpassDescriptionFlagBits.VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_QCOM);
pub const VK_SUBPASS_DESCRIPTION_SHADER_RESOLVE_BIT_QCOM = @enumToInt(enum_VkSubpassDescriptionFlagBits.VK_SUBPASS_DESCRIPTION_SHADER_RESOLVE_BIT_QCOM);
...
pub const VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT = @enumToInt(enum_VkMemoryAllocateFlagBits.VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT);
pub const VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT = @enumToInt(enum_VkMemoryAllocateFlagBits.VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT);
...
pub const VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR = @enumToInt(enum_VkMemoryAllocateFlagBits.VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR);
pub const VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = @enumToInt(enum_VkMemoryAllocateFlagBits.VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR);
...
pub const VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D11_FENCE_BIT = @enumToInt(enum_VkExternalSemaphoreHandleTypeFlagBits.VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_D3D11_FENCE_BIT);
...
pub const VK_DRIVER_ID_AMD_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_AMD_PROPRIETARY);
pub const VK_DRIVER_ID_AMD_OPEN_SOURCE = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_AMD_OPEN_SOURCE);
pub const VK_DRIVER_ID_MESA_RADV = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_MESA_RADV);
pub const VK_DRIVER_ID_NVIDIA_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_NVIDIA_PROPRIETARY);
pub const VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS);
pub const VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA);
pub const VK_DRIVER_ID_IMAGINATION_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_IMAGINATION_PROPRIETARY);
pub const VK_DRIVER_ID_QUALCOMM_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_QUALCOMM_PROPRIETARY);
pub const VK_DRIVER_ID_ARM_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_ARM_PROPRIETARY);
pub const VK_DRIVER_ID_GOOGLE_SWIFTSHADER = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_GOOGLE_SWIFTSHADER);
pub const VK_DRIVER_ID_GGP_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_GGP_PROPRIETARY);
pub const VK_DRIVER_ID_BROADCOM_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_BROADCOM_PROPRIETARY);
pub const VK_DRIVER_ID_MESA_LLVMPIPE = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_MESA_LLVMPIPE);
pub const VK_DRIVER_ID_MOLTENVK = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_MOLTENVK);
pub const VK_DRIVER_ID_AMD_PROPRIETARY_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_AMD_PROPRIETARY_KHR);
pub const VK_DRIVER_ID_AMD_OPEN_SOURCE_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_AMD_OPEN_SOURCE_KHR);
pub const VK_DRIVER_ID_MESA_RADV_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_MESA_RADV_KHR);
pub const VK_DRIVER_ID_NVIDIA_PROPRIETARY_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_NVIDIA_PROPRIETARY_KHR);
pub const VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_INTEL_PROPRIETARY_WINDOWS_KHR);
pub const VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_INTEL_OPEN_SOURCE_MESA_KHR);
pub const VK_DRIVER_ID_IMAGINATION_PROPRIETARY_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_IMAGINATION_PROPRIETARY_KHR);
pub const VK_DRIVER_ID_QUALCOMM_PROPRIETARY_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_QUALCOMM_PROPRIETARY_KHR);
pub const VK_DRIVER_ID_ARM_PROPRIETARY_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_ARM_PROPRIETARY_KHR);
pub const VK_DRIVER_ID_GOOGLE_SWIFTSHADER_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_GOOGLE_SWIFTSHADER_KHR);
pub const VK_DRIVER_ID_GGP_PROPRIETARY_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_GGP_PROPRIETARY_KHR);
pub const VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR);
pub const VK_DRIVER_ID_MAX_ENUM = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_MAX_ENUM);
pub const enum_VkDriverId = extern enum(c_int) {
...
pub const VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY = @enumToInt(enum_VkShaderFloatControlsIndependence.VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY);
pub const VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL = @enumToInt(enum_VkShaderFloatControlsIndependence.VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL);
pub const VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE = @enumToInt(enum_VkShaderFloatControlsIndependence.VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE);
pub const VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY_KHR = @enumToInt(enum_VkShaderFloatControlsIndependence.VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY_KHR);
pub const VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL_KHR = @enumToInt(enum_VkShaderFloatControlsIndependence.VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL_KHR);
pub const VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE_KHR = @enumToInt(enum_VkShaderFloatControlsIndependence.VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE_KHR);
pub const VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_MAX_ENUM = @enumToInt(enum_VkShaderFloatControlsIndependence.VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_MAX_ENUM);
pub const enum_VkShaderFloatControlsIndependence = extern enum(c_int) {
...
pub const VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE = @enumToInt(enum_VkSamplerReductionMode.VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE);
pub const VK_SAMPLER_REDUCTION_MODE_MIN = @enumToInt(enum_VkSamplerReductionMode.VK_SAMPLER_REDUCTION_MODE_MIN);
pub const VK_SAMPLER_REDUCTION_MODE_MAX = @enumToInt(enum_VkSamplerReductionMode.VK_SAMPLER_REDUCTION_MODE_MAX);
pub const VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE_EXT = @enumToInt(enum_VkSamplerReductionMode.VK_SAMPLER_REDUCTION_MODE_WEIGHTED_AVERAGE_EXT);
pub const VK_SAMPLER_REDUCTION_MODE_MIN_EXT = @enumToInt(enum_VkSamplerReductionMode.VK_SAMPLER_REDUCTION_MODE_MIN_EXT);
pub const VK_SAMPLER_REDUCTION_MODE_MAX_EXT = @enumToInt(enum_VkSamplerReductionMode.VK_SAMPLER_REDUCTION_MODE_MAX_EXT);
pub const VK_SAMPLER_REDUCTION_MODE_MAX_ENUM = @enumToInt(enum_VkSamplerReductionMode.VK_SAMPLER_REDUCTION_MODE_MAX_ENUM);
pub const enum_VkSamplerReductionMode = extern enum(c_int) {
...
pub const VK_SEMAPHORE_TYPE_BINARY = @enumToInt(enum_VkSemaphoreType.VK_SEMAPHORE_TYPE_BINARY);
pub const VK_SEMAPHORE_TYPE_TIMELINE = @enumToInt(enum_VkSemaphoreType.VK_SEMAPHORE_TYPE_TIMELINE);
pub const VK_SEMAPHORE_TYPE_BINARY_KHR = @enumToInt(enum_VkSemaphoreType.VK_SEMAPHORE_TYPE_BINARY_KHR);
pub const VK_SEMAPHORE_TYPE_TIMELINE_KHR = @enumToInt(enum_VkSemaphoreType.VK_SEMAPHORE_TYPE_TIMELINE_KHR);
pub const VK_SEMAPHORE_TYPE_MAX_ENUM = @enumToInt(enum_VkSemaphoreType.VK_SEMAPHORE_TYPE_MAX_ENUM);
pub const enum_VkSemaphoreType = extern enum(c_int) {
...
pub const VK_RESOLVE_MODE_NONE = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_NONE);
pub const VK_RESOLVE_MODE_SAMPLE_ZERO_BIT = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_SAMPLE_ZERO_BIT);
pub const VK_RESOLVE_MODE_AVERAGE_BIT = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_AVERAGE_BIT);
pub const VK_RESOLVE_MODE_MIN_BIT = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_MIN_BIT);
pub const VK_RESOLVE_MODE_MAX_BIT = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_MAX_BIT);
pub const VK_RESOLVE_MODE_NONE_KHR = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_NONE_KHR);
pub const VK_RESOLVE_MODE_SAMPLE_ZERO_BIT_KHR = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_SAMPLE_ZERO_BIT_KHR);
pub const VK_RESOLVE_MODE_AVERAGE_BIT_KHR = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_AVERAGE_BIT_KHR);
pub const VK_RESOLVE_MODE_MIN_BIT_KHR = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_MIN_BIT_KHR);
pub const VK_RESOLVE_MODE_MAX_BIT_KHR = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_MAX_BIT_KHR);
pub const VK_RESOLVE_MODE_FLAG_BITS_MAX_ENUM = @enumToInt(enum_VkResolveModeFlagBits.VK_RESOLVE_MODE_FLAG_BITS_MAX_ENUM);
pub const enum_VkResolveModeFlagBits = extern enum(c_int) {
...
pub const VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT);
pub const VK_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING_BIT = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING_BIT);
pub const VK_DESCRIPTOR_BINDING_PARTIALLY_BOUND_BIT = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_PARTIALLY_BOUND_BIT);
pub const VK_DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT_BIT = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT_BIT);
pub const VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT_EXT = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT_EXT);
pub const VK_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING_BIT_EXT = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_UPDATE_UNUSED_WHILE_PENDING_BIT_EXT);
pub const VK_DESCRIPTOR_BINDING_PARTIALLY_BOUND_BIT_EXT = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_PARTIALLY_BOUND_BIT_EXT);
pub const VK_DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT_BIT_EXT = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_VARIABLE_DESCRIPTOR_COUNT_BIT_EXT);
pub const VK_DESCRIPTOR_BINDING_FLAG_BITS_MAX_ENUM = @enumToInt(enum_VkDescriptorBindingFlagBits.VK_DESCRIPTOR_BINDING_FLAG_BITS_MAX_ENUM);
pub const enum_VkDescriptorBindingFlagBits = extern enum(c_int) {
...
pub const VK_SEMAPHORE_WAIT_ANY_BIT = @enumToInt(enum_VkSemaphoreWaitFlagBits.VK_SEMAPHORE_WAIT_ANY_BIT);
pub const VK_SEMAPHORE_WAIT_ANY_BIT_KHR = @enumToInt(enum_VkSemaphoreWaitFlagBits.VK_SEMAPHORE_WAIT_ANY_BIT_KHR);
pub const VK_SEMAPHORE_WAIT_FLAG_BITS_MAX_ENUM = @enumToInt(enum_VkSemaphoreWaitFlagBits.VK_SEMAPHORE_WAIT_FLAG_BITS_MAX_ENUM);
pub const enum_VkSemaphoreWaitFlagBits = extern enum(c_int) {
...
pub const PFN_vkCmdDrawIndirectCount = ?fn (VkCommandBuffer, VkBuffer, VkDeviceSize, VkBuffer, VkDeviceSize, u32, u32) callconv(.C) void;
pub const PFN_vkCmdDrawIndexedIndirectCount = ?fn (VkCommandBuffer, VkBuffer, VkDeviceSize, VkBuffer, VkDeviceSize, u32, u32) callconv(.C) void;
pub const PFN_vkCreateRenderPass2 = ?fn (VkDevice, [*c]const VkRenderPassCreateInfo2, [*c]const VkAllocationCallbacks, [*c]VkRenderPass) callconv(.C) VkResult;
...
pub const PFN_vkResetQueryPool = ?fn (VkDevice, VkQueryPool, u32, u32) callconv(.C) void;
pub const PFN_vkGetSemaphoreCounterValue = ?fn (VkDevice, VkSemaphore, [*c]u64) callconv(.C) VkResult;
pub const PFN_vkWaitSemaphores = ?fn (VkDevice, [*c]const VkSemaphoreWaitInfo, u64) callconv(.C) VkResult;
pub const PFN_vkSignalSemaphore = ?fn (VkDevice, [*c]const VkSemaphoreSignalInfo) callconv(.C) VkResult;
pub const PFN_vkGetBufferDeviceAddress = ?fn (VkDevice, [*c]const VkBufferDeviceAddressInfo) callconv(.C) VkDeviceAddress;
pub const PFN_vkGetBufferOpaqueCaptureAddress = ?fn (VkDevice, [*c]const VkBufferDeviceAddressInfo) callconv(.C) u64;
pub const PFN_vkGetDeviceMemoryOpaqueCaptureAddress = ?fn (VkDevice, [*c]const VkDeviceMemoryOpaqueCaptureAddressInfo) callconv(.C) u64;
...
pub const PFN_vkCreateRenderPass2KHR = ?fn (VkDevice, [*c]const VkRenderPassCreateInfo2, [*c]const VkAllocationCallbacks, [*c]VkRenderPass) callconv(.C) VkResult;
...
pub const VK_PERFORMANCE_COUNTER_UNIT_GENERIC_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_GENERIC_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_PERCENTAGE_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_PERCENTAGE_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_NANOSECONDS_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_NANOSECONDS_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_BYTES_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_BYTES_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_BYTES_PER_SECOND_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_BYTES_PER_SECOND_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_KELVIN_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_KELVIN_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_WATTS_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_WATTS_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_VOLTS_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_VOLTS_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_AMPS_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_AMPS_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_HERTZ_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_HERTZ_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_CYCLES_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_CYCLES_KHR);
pub const VK_PERFORMANCE_COUNTER_UNIT_MAX_ENUM_KHR = @enumToInt(enum_VkPerformanceCounterUnitKHR.VK_PERFORMANCE_COUNTER_UNIT_MAX_ENUM_KHR);
pub const enum_VkPerformanceCounterUnitKHR = extern enum(c_int) {
...
pub const VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR = @enumToInt(enum_VkPerformanceCounterScopeKHR.VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR);
pub const VK_PERFORMANCE_COUNTER_SCOPE_RENDER_PASS_KHR = @enumToInt(enum_VkPerformanceCounterScopeKHR.VK_PERFORMANCE_COUNTER_SCOPE_RENDER_PASS_KHR);
pub const VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_KHR = @enumToInt(enum_VkPerformanceCounterScopeKHR.VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_KHR);
pub const VK_QUERY_SCOPE_COMMAND_BUFFER_KHR = @enumToInt(enum_VkPerformanceCounterScopeKHR.VK_QUERY_SCOPE_COMMAND_BUFFER_KHR);
pub const VK_QUERY_SCOPE_RENDER_PASS_KHR = @enumToInt(enum_VkPerformanceCounterScopeKHR.VK_QUERY_SCOPE_RENDER_PASS_KHR);
pub const VK_QUERY_SCOPE_COMMAND_KHR = @enumToInt(enum_VkPerformanceCounterScopeKHR.VK_QUERY_SCOPE_COMMAND_KHR);
pub const VK_PERFORMANCE_COUNTER_SCOPE_MAX_ENUM_KHR = @enumToInt(enum_VkPerformanceCounterScopeKHR.VK_PERFORMANCE_COUNTER_SCOPE_MAX_ENUM_KHR);
pub const enum_VkPerformanceCounterScopeKHR = extern enum(c_int) {
...
pub const VK_PERFORMANCE_COUNTER_STORAGE_INT32_KHR = @enumToInt(enum_VkPerformanceCounterStorageKHR.VK_PERFORMANCE_COUNTER_STORAGE_INT32_KHR);
pub const VK_PERFORMANCE_COUNTER_STORAGE_INT64_KHR = @enumToInt(enum_VkPerformanceCounterStorageKHR.VK_PERFORMANCE_COUNTER_STORAGE_INT64_KHR);
pub const VK_PERFORMANCE_COUNTER_STORAGE_UINT32_KHR = @enumToInt(enum_VkPerformanceCounterStorageKHR.VK_PERFORMANCE_COUNTER_STORAGE_UINT32_KHR);
pub const VK_PERFORMANCE_COUNTER_STORAGE_UINT64_KHR = @enumToInt(enum_VkPerformanceCounterStorageKHR.VK_PERFORMANCE_COUNTER_STORAGE_UINT64_KHR);
pub const VK_PERFORMANCE_COUNTER_STORAGE_FLOAT32_KHR = @enumToInt(enum_VkPerformanceCounterStorageKHR.VK_PERFORMANCE_COUNTER_STORAGE_FLOAT32_KHR);
pub const VK_PERFORMANCE_COUNTER_STORAGE_FLOAT64_KHR = @enumToInt(enum_VkPerformanceCounterStorageKHR.VK_PERFORMANCE_COUNTER_STORAGE_FLOAT64_KHR);
pub const VK_PERFORMANCE_COUNTER_STORAGE_MAX_ENUM_KHR = @enumToInt(enum_VkPerformanceCounterStorageKHR.VK_PERFORMANCE_COUNTER_STORAGE_MAX_ENUM_KHR);
pub const enum_VkPerformanceCounterStorageKHR = extern enum(c_int) {
...
pub const VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_KHR = @enumToInt(enum_VkPerformanceCounterDescriptionFlagBitsKHR.VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_KHR);
pub const VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_KHR = @enumToInt(enum_VkPerformanceCounterDescriptionFlagBitsKHR.VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_KHR);
pub const VK_PERFORMANCE_COUNTER_DESCRIPTION_FLAG_BITS_MAX_ENUM_KHR = @enumToInt(enum_VkPerformanceCounterDescriptionFlagBitsKHR.VK_PERFORMANCE_COUNTER_DESCRIPTION_FLAG_BITS_MAX_ENUM_KHR);
pub const enum_VkPerformanceCounterDescriptionFlagBitsKHR = extern enum(c_int) {
...
pub const VK_ACQUIRE_PROFILING_LOCK_FLAG_BITS_MAX_ENUM_KHR = @enumToInt(enum_VkAcquireProfilingLockFlagBitsKHR.VK_ACQUIRE_PROFILING_LOCK_FLAG_BITS_MAX_ENUM_KHR);
pub const enum_VkAcquireProfilingLockFlagBitsKHR = extern enum(c_int) {
...
pub const PFN_vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR = ?fn (VkPhysicalDevice, u32, [*c]u32, [*c]VkPerformanceCounterKHR, [*c]VkPerformanceCounterDescriptionKHR) callconv(.C) VkResult;
pub const PFN_vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR = ?fn (VkPhysicalDevice, [*c]const VkQueryPoolPerformanceCreateInfoKHR, [*c]u32) callconv(.C) void;
pub const PFN_vkAcquireProfilingLockKHR = ?fn (VkDevice, [*c]const VkAcquireProfilingLockInfoKHR) callconv(.C) VkResult;
pub const PFN_vkReleaseProfilingLockKHR = ?fn (VkDevice) callconv(.C) void;
...
pub const PFN_vkGetSemaphoreCounterValueKHR = ?fn (VkDevice, VkSemaphore, [*c]u64) callconv(.C) VkResult;
pub const PFN_vkWaitSemaphoresKHR = ?fn (VkDevice, [*c]const VkSemaphoreWaitInfo, u64) callconv(.C) VkResult;
pub const PFN_vkSignalSemaphoreKHR = ?fn (VkDevice, [*c]const VkSemaphoreSignalInfo) callconv(.C) VkResult;
...
pub const PFN_vkGetBufferDeviceAddressKHR = ?fn (VkDevice, [*c]const VkBufferDeviceAddressInfo) callconv(.C) VkDeviceAddress;
pub const PFN_vkGetBufferOpaqueCaptureAddressKHR = ?fn (VkDevice, [*c]const VkBufferDeviceAddressInfo) callconv(.C) u64;
pub const PFN_vkGetDeviceMemoryOpaqueCaptureAddressKHR = ?fn (VkDevice, [*c]const VkDeviceMemoryOpaqueCaptureAddressInfo) callconv(.C) u64;
...
pub const VK_DEBUG_REPORT_OBJECT_TYPE_ACCELERATION_STRUCTURE_KHR_EXT = @enumToInt(enum_VkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_ACCELERATION_STRUCTURE_KHR_EXT);
...
pub const PFN_vkGetImageViewAddressNVX = ?fn (VkDevice, VkImageView, [*c]VkImageViewAddressPropertiesNVX) callconv(.C) VkResult;
...
pub const VkAccelerationStructureNV = VkAccelerationStructureKHR;
pub const VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR = @enumToInt(enum_VkRayTracingShaderGroupTypeKHR.VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_KHR);
pub const VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR = @enumToInt(enum_VkRayTracingShaderGroupTypeKHR.VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_KHR);
pub const VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR = @enumToInt(enum_VkRayTracingShaderGroupTypeKHR.VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_KHR);
pub const VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_NV = @enumToInt(enum_VkRayTracingShaderGroupTypeKHR.VK_RAY_TRACING_SHADER_GROUP_TYPE_GENERAL_NV);
pub const VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_NV = @enumToInt(enum_VkRayTracingShaderGroupTypeKHR.VK_RAY_TRACING_SHADER_GROUP_TYPE_TRIANGLES_HIT_GROUP_NV);
pub const VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_NV = @enumToInt(enum_VkRayTracingShaderGroupTypeKHR.VK_RAY_TRACING_SHADER_GROUP_TYPE_PROCEDURAL_HIT_GROUP_NV);
pub const VK_RAY_TRACING_SHADER_GROUP_TYPE_MAX_ENUM_KHR = @enumToInt(enum_VkRayTracingShaderGroupTypeKHR.VK_RAY_TRACING_SHADER_GROUP_TYPE_MAX_ENUM_KHR);
pub const enum_VkRayTracingShaderGroupTypeKHR = extern enum(c_int) {
...
pub const VK_GEOMETRY_TYPE_TRIANGLES_KHR = @enumToInt(enum_VkGeometryTypeKHR.VK_GEOMETRY_TYPE_TRIANGLES_KHR);
pub const VK_GEOMETRY_TYPE_AABBS_KHR = @enumToInt(enum_VkGeometryTypeKHR.VK_GEOMETRY_TYPE_AABBS_KHR);
pub const VK_GEOMETRY_TYPE_INSTANCES_KHR = @enumToInt(enum_VkGeometryTypeKHR.VK_GEOMETRY_TYPE_INSTANCES_KHR);
pub const VK_GEOMETRY_TYPE_TRIANGLES_NV = @enumToInt(enum_VkGeometryTypeKHR.VK_GEOMETRY_TYPE_TRIANGLES_NV);
pub const VK_GEOMETRY_TYPE_AABBS_NV = @enumToInt(enum_VkGeometryTypeKHR.VK_GEOMETRY_TYPE_AABBS_NV);
pub const VK_GEOMETRY_TYPE_MAX_ENUM_KHR = @enumToInt(enum_VkGeometryTypeKHR.VK_GEOMETRY_TYPE_MAX_ENUM_KHR);
pub const enum_VkGeometryTypeKHR = extern enum(c_int) {
...
pub const VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR = @enumToInt(enum_VkAccelerationStructureTypeKHR.VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR);
pub const VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR = @enumToInt(enum_VkAccelerationStructureTypeKHR.VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR);
pub const VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_NV = @enumToInt(enum_VkAccelerationStructureTypeKHR.VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_NV);
pub const VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NV = @enumToInt(enum_VkAccelerationStructureTypeKHR.VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_NV);
pub const VK_ACCELERATION_STRUCTURE_TYPE_MAX_ENUM_KHR = @enumToInt(enum_VkAccelerationStructureTypeKHR.VK_ACCELERATION_STRUCTURE_TYPE_MAX_ENUM_KHR);
pub const enum_VkAccelerationStructureTypeKHR = extern enum(c_int) {
...
pub const VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_KHR = @enumToInt(enum_VkCopyAccelerationStructureModeKHR.VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_KHR);
pub const VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_KHR = @enumToInt(enum_VkCopyAccelerationStructureModeKHR.VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_KHR);
pub const VK_COPY_ACCELERATION_STRUCTURE_MODE_SERIALIZE_KHR = @enumToInt(enum_VkCopyAccelerationStructureModeKHR.VK_COPY_ACCELERATION_STRUCTURE_MODE_SERIALIZE_KHR);
pub const VK_COPY_ACCELERATION_STRUCTURE_MODE_DESERIALIZE_KHR = @enumToInt(enum_VkCopyAccelerationStructureModeKHR.VK_COPY_ACCELERATION_STRUCTURE_MODE_DESERIALIZE_KHR);
pub const VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_NV = @enumToInt(enum_VkCopyAccelerationStructureModeKHR.VK_COPY_ACCELERATION_STRUCTURE_MODE_CLONE_NV);
pub const VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_NV = @enumToInt(enum_VkCopyAccelerationStructureModeKHR.VK_COPY_ACCELERATION_STRUCTURE_MODE_COMPACT_NV);
pub const VK_COPY_ACCELERATION_STRUCTURE_MODE_MAX_ENUM_KHR = @enumToInt(enum_VkCopyAccelerationStructureModeKHR.VK_COPY_ACCELERATION_STRUCTURE_MODE_MAX_ENUM_KHR);
pub const enum_VkCopyAccelerationStructureModeKHR = extern enum(c_int) {
...
pub const VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_OBJECT_KHR = @enumToInt(enum_VkAccelerationStructureMemoryRequirementsTypeKHR.VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_OBJECT_KHR);
pub const VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_BUILD_SCRATCH_KHR = @enumToInt(enum_VkAccelerationStructureMemoryRequirementsTypeKHR.VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_BUILD_SCRATCH_KHR);
pub const VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_UPDATE_SCRATCH_KHR = @enumToInt(enum_VkAccelerationStructureMemoryRequirementsTypeKHR.VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_UPDATE_SCRATCH_KHR);
pub const VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_OBJECT_NV = @enumToInt(enum_VkAccelerationStructureMemoryRequirementsTypeKHR.VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_OBJECT_NV);
pub const VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_BUILD_SCRATCH_NV = @enumToInt(enum_VkAccelerationStructureMemoryRequirementsTypeKHR.VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_BUILD_SCRATCH_NV);
pub const VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_UPDATE_SCRATCH_NV = @enumToInt(enum_VkAccelerationStructureMemoryRequirementsTypeKHR.VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_UPDATE_SCRATCH_NV);
pub const VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_MAX_ENUM_KHR = @enumToInt(enum_VkAccelerationStructureMemoryRequirementsTypeKHR.VK_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_TYPE_MAX_ENUM_KHR);
pub const enum_VkAccelerationStructureMemoryRequirementsTypeKHR = extern enum(c_int) {
...
pub const VkAccelerationStructureMemoryRequirementsTypeKHR = enum_VkAccelerationStructureMemoryRequirementsTypeKHR;
pub const VkAccelerationStructureMemoryRequirementsTypeNV = VkAccelerationStructureMemoryRequirementsTypeKHR;
pub const VK_GEOMETRY_OPAQUE_BIT_KHR = @enumToInt(enum_VkGeometryFlagBitsKHR.VK_GEOMETRY_OPAQUE_BIT_KHR);
pub const VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_KHR = @enumToInt(enum_VkGeometryFlagBitsKHR.VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_KHR);
pub const VK_GEOMETRY_OPAQUE_BIT_NV = @enumToInt(enum_VkGeometryFlagBitsKHR.VK_GEOMETRY_OPAQUE_BIT_NV);
pub const VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_NV = @enumToInt(enum_VkGeometryFlagBitsKHR.VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_NV);
pub const VK_GEOMETRY_FLAG_BITS_MAX_ENUM_KHR = @enumToInt(enum_VkGeometryFlagBitsKHR.VK_GEOMETRY_FLAG_BITS_MAX_ENUM_KHR);
pub const enum_VkGeometryFlagBitsKHR = extern enum(c_int) {
...
pub const VK_GEOMETRY_INSTANCE_TRIANGLE_FACING_CULL_DISABLE_BIT_KHR = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_TRIANGLE_FACING_CULL_DISABLE_BIT_KHR);
pub const VK_GEOMETRY_INSTANCE_TRIANGLE_FRONT_COUNTERCLOCKWISE_BIT_KHR = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_TRIANGLE_FRONT_COUNTERCLOCKWISE_BIT_KHR);
pub const VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_KHR = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_KHR);
pub const VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_KHR = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_KHR);
pub const VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_DISABLE_BIT_NV = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_DISABLE_BIT_NV);
pub const VK_GEOMETRY_INSTANCE_TRIANGLE_FRONT_COUNTERCLOCKWISE_BIT_NV = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_TRIANGLE_FRONT_COUNTERCLOCKWISE_BIT_NV);
pub const VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_NV = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_NV);
pub const VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_NV = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_NV);
pub const VK_GEOMETRY_INSTANCE_FLAG_BITS_MAX_ENUM_KHR = @enumToInt(enum_VkGeometryInstanceFlagBitsKHR.VK_GEOMETRY_INSTANCE_FLAG_BITS_MAX_ENUM_KHR);
pub const enum_VkGeometryInstanceFlagBitsKHR = extern enum(c_int) {
...
pub const VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_KHR = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_KHR);
pub const VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_KHR = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_KHR);
pub const VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_KHR = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_KHR);
pub const VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_KHR = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_KHR);
pub const VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT_KHR = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT_KHR);
pub const VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_NV = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_NV);
pub const VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_NV = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_NV);
pub const VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_NV = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_NV);
pub const VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_NV = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_NV);
pub const VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT_NV = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT_NV);
pub const VK_BUILD_ACCELERATION_STRUCTURE_FLAG_BITS_MAX_ENUM_KHR = @enumToInt(enum_VkBuildAccelerationStructureFlagBitsKHR.VK_BUILD_ACCELERATION_STRUCTURE_FLAG_BITS_MAX_ENUM_KHR);
pub const enum_VkBuildAccelerationStructureFlagBitsKHR = extern enum(c_int) {
...
pub const struct_VkBindAccelerationStructureMemoryInfoKHR = extern struct {
    sType: VkStructureType,
    pNext: ?*const c_void,
...
pub const VkBindAccelerationStructureMemoryInfoKHR = struct_VkBindAccelerationStructureMemoryInfoKHR;
pub const VkBindAccelerationStructureMemoryInfoNV = VkBindAccelerationStructureMemoryInfoKHR;
...
pub const VkWriteDescriptorSetAccelerationStructureNV = VkWriteDescriptorSetAccelerationStructureKHR;
...
pub const struct_VkAccelerationStructureInstanceKHR = opaque {}; // E:/Libraries/VulkanSDK/1.2.148.1/Include\vulkan/vulkan_core.h:9226:35: warning: struct demoted to opaque type - has bitfield
...
pub const PFN_vkDestroyAccelerationStructureKHR = ?fn (VkDevice, VkAccelerationStructureKHR, [*c]const VkAllocationCallbacks) callconv(.C) void;
pub const PFN_vkDestroyAccelerationStructureNV = ?fn (VkDevice, VkAccelerationStructureKHR, [*c]const VkAllocationCallbacks) callconv(.C) void;
...
pub const PFN_vkBindAccelerationStructureMemoryKHR = ?fn (VkDevice, u32, [*c]const VkBindAccelerationStructureMemoryInfoKHR) callconv(.C) VkResult;
pub const PFN_vkBindAccelerationStructureMemoryNV = ?fn (VkDevice, u32, [*c]const VkBindAccelerationStructureMemoryInfoKHR) callconv(.C) VkResult;
pub const PFN_vkCmdBuildAccelerationStructureNV = ?fn (VkCommandBuffer, [*c]const VkAccelerationStructureInfoNV, VkBuffer, VkDeviceSize, VkBool32, VkAccelerationStructureKHR, VkAccelerationStructureKHR, VkBuffer, VkDeviceSize) callconv(.C) void;
pub const PFN_vkCmdCopyAccelerationStructureNV = ?fn (VkCommandBuffer, VkAccelerationStructureKHR, VkAccelerationStructureKHR, VkCopyAccelerationStructureModeKHR) callconv(.C) void;
...
pub const PFN_vkGetRayTracingShaderGroupHandlesKHR = ?fn (VkDevice, VkPipeline, u32, u32, usize, ?*c_void) callconv(.C) VkResult;
pub const PFN_vkGetRayTracingShaderGroupHandlesNV = ?fn (VkDevice, VkPipeline, u32, u32, usize, ?*c_void) callconv(.C) VkResult;
pub const PFN_vkGetAccelerationStructureHandleNV = ?fn (VkDevice, VkAccelerationStructureKHR, usize, ?*c_void) callconv(.C) VkResult;
...
pub const PFN_vkCmdWriteAccelerationStructuresPropertiesNV = ?fn (VkCommandBuffer, u32, [*c]const VkAccelerationStructureKHR, VkQueryType, VkQueryPool, u32) callconv(.C) void;
...
pub extern fn vkDestroyAccelerationStructureNV(device: VkDevice, accelerationStructure: VkAccelerationStructureKHR, pAllocator: [*c]const VkAllocationCallbacks) void;
...
pub extern fn vkBindAccelerationStructureMemoryKHR(device: VkDevice, bindInfoCount: u32, pBindInfos: [*c]const VkBindAccelerationStructureMemoryInfoKHR) VkResult;
pub extern fn vkBindAccelerationStructureMemoryNV(device: VkDevice, bindInfoCount: u32, pBindInfos: [*c]const VkBindAccelerationStructureMemoryInfoKHR) VkResult;
pub extern fn vkCmdBuildAccelerationStructureNV(commandBuffer: VkCommandBuffer, pInfo: [*c]const VkAccelerationStructureInfoNV, instanceData: VkBuffer, instanceOffset: VkDeviceSize, update: VkBool32, dst: VkAccelerationStructureKHR, src: VkAccelerationStructureKHR, scratch: VkBuffer, scratchOffset: VkDeviceSize) void;
pub extern fn vkCmdCopyAccelerationStructureNV(commandBuffer: VkCommandBuffer, dst: VkAccelerationStructureKHR, src: VkAccelerationStructureKHR, mode: VkCopyAccelerationStructureModeKHR) void;
...
pub extern fn vkGetRayTracingShaderGroupHandlesKHR(device: VkDevice, pipeline: VkPipeline, firstGroup: u32, groupCount: u32, dataSize: usize, pData: ?*c_void) VkResult;
...
pub extern fn vkGetAccelerationStructureHandleNV(device: VkDevice, accelerationStructure: VkAccelerationStructureKHR, dataSize: usize, pData: ?*c_void) VkResult;
...
pub extern fn vkCmdWriteAccelerationStructuresPropertiesNV(commandBuffer: VkCommandBuffer, accelerationStructureCount: u32, pAccelerationStructures: [*c]const VkAccelerationStructureKHR, queryType: VkQueryType, queryPool: VkQueryPool, firstQuery: u32) void;
...
pub const PFN_vkGetBufferDeviceAddressEXT = ?fn (VkDevice, [*c]const VkBufferDeviceAddressInfo) callconv(.C) VkDeviceAddress;
pub extern fn vkGetBufferDeviceAddressEXT(device: VkDevice, pInfo: [*c]const VkBufferDeviceAddressInfo) VkDeviceAddress;
pub const VK_TOOL_PURPOSE_VALIDATION_BIT_EXT = @enumToInt(enum_VkToolPurposeFlagBitsEXT.VK_TOOL_PURPOSE_VALIDATION_BIT_EXT);
pub const VK_TOOL_PURPOSE_PROFILING_BIT_EXT = @enumToInt(enum_VkToolPurposeFlagBitsEXT.VK_TOOL_PURPOSE_PROFILING_BIT_EXT);
pub const VK_TOOL_PURPOSE_TRACING_BIT_EXT = @enumToInt(enum_VkToolPurposeFlagBitsEXT.VK_TOOL_PURPOSE_TRACING_BIT_EXT);
pub const VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT_EXT = @enumToInt(enum_VkToolPurposeFlagBitsEXT.VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT_EXT);
pub const VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT_EXT = @enumToInt(enum_VkToolPurposeFlagBitsEXT.VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT_EXT);
pub const VK_TOOL_PURPOSE_DEBUG_REPORTING_BIT_EXT = @enumToInt(enum_VkToolPurposeFlagBitsEXT.VK_TOOL_PURPOSE_DEBUG_REPORTING_BIT_EXT);
pub const VK_TOOL_PURPOSE_DEBUG_MARKERS_BIT_EXT = @enumToInt(enum_VkToolPurposeFlagBitsEXT.VK_TOOL_PURPOSE_DEBUG_MARKERS_BIT_EXT);
pub const VK_TOOL_PURPOSE_FLAG_BITS_MAX_ENUM_EXT = @enumToInt(enum_VkToolPurposeFlagBitsEXT.VK_TOOL_PURPOSE_FLAG_BITS_MAX_ENUM_EXT);
pub const enum_VkToolPurposeFlagBitsEXT = extern enum(c_int) {
...
pub const struct_VkPhysicalDeviceToolPropertiesEXT = extern struct {
    sType: VkStructureType,
    pNext: ?*c_void,
    name: [256]u8,
    version: [256]u8,
...
pub const VkPhysicalDeviceToolPropertiesEXT = struct_VkPhysicalDeviceToolPropertiesEXT;
pub const PFN_vkGetPhysicalDeviceToolPropertiesEXT = ?fn (VkPhysicalDevice, [*c]u32, [*c]VkPhysicalDeviceToolPropertiesEXT) callconv(.C) VkResult;
pub extern fn vkGetPhysicalDeviceToolPropertiesEXT(physicalDevice: VkPhysicalDevice, pToolCount: [*c]u32, pToolProperties: [*c]VkPhysicalDeviceToolPropertiesEXT) VkResult;
...
pub const VK_VALIDATION_FEATURE_ENABLE_DEBUG_PRINTF_EXT = @enumToInt(enum_VkValidationFeatureEnableEXT.VK_VALIDATION_FEATURE_ENABLE_DEBUG_PRINTF_EXT);
...
pub const PFN_vkCmdBindVertexBuffers2EXT = ?fn (VkCommandBuffer, u32, u32, [*c]const VkBuffer, [*c]const VkDeviceSize, [*c]const VkDeviceSize, [*c]const VkDeviceSize) callconv(.C) void;
...
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_SHADER_GROUP_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_SHADER_GROUP_NV);
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_STATE_FLAGS_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_STATE_FLAGS_NV);
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_INDEX_BUFFER_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_INDEX_BUFFER_NV);
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_VERTEX_BUFFER_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_VERTEX_BUFFER_NV);
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_PUSH_CONSTANT_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_PUSH_CONSTANT_NV);
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_INDEXED_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_INDEXED_NV);
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_NV);
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_TASKS_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_DRAW_TASKS_NV);
pub const VK_INDIRECT_COMMANDS_TOKEN_TYPE_MAX_ENUM_NV = @enumToInt(enum_VkIndirectCommandsTokenTypeNV.VK_INDIRECT_COMMANDS_TOKEN_TYPE_MAX_ENUM_NV);
pub const enum_VkIndirectCommandsTokenTypeNV = extern enum(c_int) {
...
pub const VK_INDIRECT_STATE_FLAG_FRONTFACE_BIT_NV = @enumToInt(enum_VkIndirectStateFlagBitsNV.VK_INDIRECT_STATE_FLAG_FRONTFACE_BIT_NV);
pub const VK_INDIRECT_STATE_FLAG_BITS_MAX_ENUM_NV = @enumToInt(enum_VkIndirectStateFlagBitsNV.VK_INDIRECT_STATE_FLAG_BITS_MAX_ENUM_NV);
pub const enum_VkIndirectStateFlagBitsNV = extern enum(c_int) {
...
pub const VK_INDIRECT_COMMANDS_LAYOUT_USAGE_EXPLICIT_PREPROCESS_BIT_NV = @enumToInt(enum_VkIndirectCommandsLayoutUsageFlagBitsNV.VK_INDIRECT_COMMANDS_LAYOUT_USAGE_EXPLICIT_PREPROCESS_BIT_NV);
pub const VK_INDIRECT_COMMANDS_LAYOUT_USAGE_INDEXED_SEQUENCES_BIT_NV = @enumToInt(enum_VkIndirectCommandsLayoutUsageFlagBitsNV.VK_INDIRECT_COMMANDS_LAYOUT_USAGE_INDEXED_SEQUENCES_BIT_NV);
pub const VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_BIT_NV = @enumToInt(enum_VkIndirectCommandsLayoutUsageFlagBitsNV.VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_BIT_NV);
pub const VK_INDIRECT_COMMANDS_LAYOUT_USAGE_FLAG_BITS_MAX_ENUM_NV = @enumToInt(enum_VkIndirectCommandsLayoutUsageFlagBitsNV.VK_INDIRECT_COMMANDS_LAYOUT_USAGE_FLAG_BITS_MAX_ENUM_NV);
pub const enum_VkIndirectCommandsLayoutUsageFlagBitsNV = extern enum(c_int) {
...
pub const PFN_vkGetGeneratedCommandsMemoryRequirementsNV = ?fn (VkDevice, [*c]const VkGeneratedCommandsMemoryRequirementsInfoNV, [*c]VkMemoryRequirements2) callconv(.C) void;
...
pub const PFN_vkCreateIndirectCommandsLayoutNV = ?fn (VkDevice, [*c]const VkIndirectCommandsLayoutCreateInfoNV, [*c]const VkAllocationCallbacks, [*c]VkIndirectCommandsLayoutNV) callconv(.C) VkResult;
pub const PFN_vkDestroyIndirectCommandsLayoutNV = ?fn (VkDevice, VkIndirectCommandsLayoutNV, [*c]const VkAllocationCallbacks) callconv(.C) void;
...
pub const VK_PRIVATE_DATA_SLOT_CREATE_FLAG_BITS_MAX_ENUM_EXT = @enumToInt(enum_VkPrivateDataSlotCreateFlagBitsEXT.VK_PRIVATE_DATA_SLOT_CREATE_FLAG_BITS_MAX_ENUM_EXT);
pub const enum_VkPrivateDataSlotCreateFlagBitsEXT = extern enum(c_int) {
...
pub const struct_VkPhysicalDevicePrivateDataFeaturesEXT = extern struct {
    sType: VkStructureType,
    pNext: ?*c_void,
    privateData: VkBool32,
};
pub const VkPhysicalDevicePrivateDataFeaturesEXT = struct_VkPhysicalDevicePrivateDataFeaturesEXT;
pub const struct_VkDevicePrivateDataCreateInfoEXT = extern struct {
    sType: VkStructureType,
    pNext: ?*const c_void,
    privateDataSlotRequestCount: u32,
};
pub const VkDevicePrivateDataCreateInfoEXT = struct_VkDevicePrivateDataCreateInfoEXT;
...
pub const PFN_vkCreatePrivateDataSlotEXT = ?fn (VkDevice, [*c]const VkPrivateDataSlotCreateInfoEXT, [*c]const VkAllocationCallbacks, [*c]VkPrivateDataSlotEXT) callconv(.C) VkResult;
pub const PFN_vkDestroyPrivateDataSlotEXT = ?fn (VkDevice, VkPrivateDataSlotEXT, [*c]const VkAllocationCallbacks) callconv(.C) void;
pub const PFN_vkSetPrivateDataEXT = ?fn (VkDevice, VkObjectType, u64, VkPrivateDataSlotEXT, u64) callconv(.C) VkResult;
pub const PFN_vkGetPrivateDataEXT = ?fn (VkDevice, VkObjectType, u64, VkPrivateDataSlotEXT, [*c]u64) callconv(.C) void;
pub extern fn vkCreatePrivateDataSlotEXT(device: VkDevice, pCreateInfo: [*c]const VkPrivateDataSlotCreateInfoEXT, pAllocator: [*c]const VkAllocationCallbacks, pPrivateDataSlot: [*c]VkPrivateDataSlotEXT) VkResult;
pub extern fn vkDestroyPrivateDataSlotEXT(device: VkDevice, privateDataSlot: VkPrivateDataSlotEXT, pAllocator: [*c]const VkAllocationCallbacks) void;
pub extern fn vkSetPrivateDataEXT(device: VkDevice, objectType: VkObjectType, objectHandle: u64, privateDataSlot: VkPrivateDataSlotEXT, data: u64) VkResult;
pub extern fn vkGetPrivateDataEXT(device: VkDevice, objectType: VkObjectType, objectHandle: u64, privateDataSlot: VkPrivateDataSlotEXT, pData: [*c]u64) void;
pub const struct_VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT = extern struct {
    sType: VkStructureType,
    pNext: ?*c_void,
    pipelineCreationCacheControl: VkBool32,
};
pub const VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT = struct_VkPhysicalDevicePipelineCreationCacheControlFeaturesEXT;
pub const VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_SHADER_DEBUG_INFO_BIT_NV = @enumToInt(enum_VkDeviceDiagnosticsConfigFlagBitsNV.VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_SHADER_DEBUG_INFO_BIT_NV);
pub const VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_RESOURCE_TRACKING_BIT_NV = @enumToInt(enum_VkDeviceDiagnosticsConfigFlagBitsNV.VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_RESOURCE_TRACKING_BIT_NV);
pub const VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_AUTOMATIC_CHECKPOINTS_BIT_NV = @enumToInt(enum_VkDeviceDiagnosticsConfigFlagBitsNV.VK_DEVICE_DIAGNOSTICS_CONFIG_ENABLE_AUTOMATIC_CHECKPOINTS_BIT_NV);
pub const VK_DEVICE_DIAGNOSTICS_CONFIG_FLAG_BITS_MAX_ENUM_NV = @enumToInt(enum_VkDeviceDiagnosticsConfigFlagBitsNV.VK_DEVICE_DIAGNOSTICS_CONFIG_FLAG_BITS_MAX_ENUM_NV);
pub const enum_VkDeviceDiagnosticsConfigFlagBitsNV = extern enum(c_int) {
...
pub const struct_VkPhysicalDeviceImageRobustnessFeaturesEXT = extern struct {
    sType: VkStructureType,
    pNext: ?*c_void,
    robustImageAccess: VkBool32,
};
pub const VkPhysicalDeviceImageRobustnessFeaturesEXT = struct_VkPhysicalDeviceImageRobustnessFeaturesEXT;
...
pub const __stdint_join3 = @compileError("unable to translate C expr: unexpected token .HashHash"); // C:\Users\Bas\lib\zig\include\stdint.h:245:9
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token .HashHash"); // C:\Users\Bas\lib\zig\include\stdint.h:282:9
pub const __uint_c = @compileError("unable to translate C expr: expected ',' or ')'"); // C:\Users\Bas\lib\zig\include\stdint.h:284:9
pub const VK_DEFINE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // E:/Libraries/VulkanSDK/1.2.148.1/Include\vulkan/vulkan_core.h:25:9
pub const VK_DEFINE_NON_DISPATCHABLE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // E:/Libraries/VulkanSDK/1.2.148.1/Include\vulkan/vulkan_core.h:30:17
...
pub const __znver2 = 1;
pub const __znver2__ = 1;
pub const __tune_znver2__ = 1;
...
pub const _WIN32 = 1;
pub const _WIN64 = 1;
pub const _MSC_VER = 1927;
pub const _MSC_FULL_VER = 192729112;
...
pub const VK_HEADER_VERSION = 148;
pub const VK_HEADER_VERSION_COMPLETE = VK_MAKE_VERSION(1, 2, VK_HEADER_VERSION);
pub inline fn VK_VERSION_MAJOR(version: anytype) @TypeOf((@import("std").meta.cast(u32, version)) >> 22) {
    return (@import("std").meta.cast(u32, version)) >> 22;
}
pub inline fn VK_VERSION_MINOR(version: anytype) @TypeOf(((@import("std").meta.cast(u32, version)) >> 12) & 0x3ff) {
    return ((@import("std").meta.cast(u32, version)) >> 12) & 0x3ff;
}
pub inline fn VK_VERSION_PATCH(version: anytype) @TypeOf((@import("std").meta.cast(u32, version)) & 0xfff) {
...
pub const VK_VERSION_1_2 = 1;
pub const VK_API_VERSION_1_2 = VK_MAKE_VERSION(1, 2, 0);
pub const VK_MAX_DRIVER_NAME_SIZE = 256;
pub const VK_MAX_DRIVER_INFO_SIZE = 256;
...
pub const VK_KHR_performance_query = 1;
pub const VK_KHR_PERFORMANCE_QUERY_SPEC_VERSION = 1;
...
pub const VK_KHR_shader_subgroup_extended_types = 1;
pub const VK_KHR_SHADER_SUBGROUP_EXTENDED_TYPES_SPEC_VERSION = 1;
...
pub const VK_KHR_shader_clock = 1;
pub const VK_KHR_SHADER_CLOCK_SPEC_VERSION = 1;
...
pub const VK_KHR_timeline_semaphore = 1;
pub const VK_KHR_TIMELINE_SEMAPHORE_SPEC_VERSION = 2;
...
pub const VK_KHR_spirv_1_4 = 1;
pub const VK_KHR_SPIRV_1_4_SPEC_VERSION = 1;
...
pub const VK_KHR_separate_depth_stencil_layouts = 1;
pub const VK_KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_SPEC_VERSION = 1;
...
pub const VK_KHR_buffer_device_address = 1;
pub const VK_KHR_BUFFER_DEVICE_ADDRESS_SPEC_VERSION = 1;
...
pub const VK_KHR_shader_non_semantic_info = 1;
pub const VK_KHR_SHADER_NON_SEMANTIC_INFO_SPEC_VERSION = 1;
...
pub const VK_NVX_IMAGE_VIEW_HANDLE_SPEC_VERSION = 2;
...
pub const VK_EXT_VALIDATION_FLAGS_SPEC_VERSION = 2;
...
pub const VK_EXT_DEBUG_UTILS_SPEC_VERSION = 2;
...
pub const VK_EXT_FILTER_CUBIC_SPEC_VERSION = 3;
pub const VK_EXT_FILTER_CUBIC_EXTENSION_NAME = "VK_EXT_filter_cubic";
pub const VK_QCOM_render_pass_shader_resolve = 1;
pub const VK_QCOM_RENDER_PASS_SHADER_RESOLVE_SPEC_VERSION = 4;
...
pub const VK_INTEL_PERFORMANCE_QUERY_SPEC_VERSION = 2;
...
pub const VK_EXT_tooling_info = 1;
pub const VK_EXT_TOOLING_INFO_SPEC_VERSION = 1;
...
pub const VK_EXT_VALIDATION_FEATURES_SPEC_VERSION = 3;
...
pub const VK_EXT_HEADLESS_SURFACE_SPEC_VERSION = 1;
...
pub const VK_EXT_shader_atomic_float = 1;
pub const VK_EXT_SHADER_ATOMIC_FLOAT_SPEC_VERSION = 1;
...
pub const VK_EXT_extended_dynamic_state = 1;
pub const VK_EXT_EXTENDED_DYNAMIC_STATE_SPEC_VERSION = 1;
...
pub const VK_NV_device_generated_commands = 1;
pub const VK_NV_DEVICE_GENERATED_COMMANDS_SPEC_VERSION = 3;
...
pub const VK_QCOM_render_pass_transform = 1;
pub const VK_QCOM_RENDER_PASS_TRANSFORM_SPEC_VERSION = 1;
pub const VK_QCOM_RENDER_PASS_TRANSFORM_EXTENSION_NAME = "VK_QCOM_render_pass_transform";
pub const VK_EXT_robustness2 = 1;
pub const VK_EXT_ROBUSTNESS_2_SPEC_VERSION = 1;
pub const VK_EXT_ROBUSTNESS_2_EXTENSION_NAME = "VK_EXT_robustness2";
pub const VK_EXT_custom_border_color = 1;
pub const VK_EXT_CUSTOM_BORDER_COLOR_SPEC_VERSION = 12;
pub const VK_EXT_CUSTOM_BORDER_COLOR_EXTENSION_NAME = "VK_EXT_custom_border_color";
pub const VK_GOOGLE_user_type = 1;
pub const VK_GOOGLE_USER_TYPE_SPEC_VERSION = 1;
pub const VK_GOOGLE_USER_TYPE_EXTENSION_NAME = "VK_GOOGLE_user_type";
pub const VK_EXT_private_data = 1;
pub const VK_EXT_PRIVATE_DATA_SPEC_VERSION = 1;
pub const VK_EXT_PRIVATE_DATA_EXTENSION_NAME = "VK_EXT_private_data";
pub const VK_EXT_pipeline_creation_cache_control = 1;
pub const VK_EXT_PIPELINE_CREATION_CACHE_CONTROL_SPEC_VERSION = 3;
pub const VK_EXT_PIPELINE_CREATION_CACHE_CONTROL_EXTENSION_NAME = "VK_EXT_pipeline_creation_cache_control";
pub const VK_NV_device_diagnostics_config = 1;
pub const VK_NV_DEVICE_DIAGNOSTICS_CONFIG_SPEC_VERSION = 1;
pub const VK_NV_DEVICE_DIAGNOSTICS_CONFIG_EXTENSION_NAME = "VK_NV_device_diagnostics_config";
pub const VK_QCOM_render_pass_store_ops = 1;
pub const VK_QCOM_render_pass_store_ops_SPEC_VERSION = 2;
pub const VK_QCOM_render_pass_store_ops_EXTENSION_NAME = "VK_QCOM_render_pass_store_ops";
pub const VK_EXT_fragment_density_map2 = 1;
pub const VK_EXT_FRAGMENT_DENSITY_MAP_2_SPEC_VERSION = 1;
pub const VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME = "VK_EXT_fragment_density_map2";
pub const VK_EXT_image_robustness = 1;
pub const VK_EXT_IMAGE_ROBUSTNESS_SPEC_VERSION = 1;
